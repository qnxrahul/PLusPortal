...
{
    public static void AddRockITHealthChecks(this IServiceCollection services)
    {
        // Add your health checks here
        var healthChecksBuilder = services.AddHealthChecks();
        healthChecksBuilder.AddCheck<RockITDatabaseCheck>("RockIT DbContext Check", tags: new string[] { "database" });
        ...
        {
            settings.AddHealthCheckEndpoint("RockIT Health Status", healthCheckUrl);
        });
