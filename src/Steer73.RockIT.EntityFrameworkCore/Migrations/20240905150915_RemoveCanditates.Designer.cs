...
namespace Steer73.RockIT.Migrations
{
    ...
    [Migration("20240905150915_RemoveCanditates")]
    partial class RemoveCanditates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Steer73.RockIT.Applicants.Applicant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Steer73.RockIT.VacancyApplications.VacancyApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppVacancyApplications", (string)null);
                });

            modelBuilder.Entity("Steer73.RockIT.VacancyFormDefinitions.VacancyFormDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppVacancyFormDefinitions", (string)null);
                });

            modelBuilder.Entity("Steer73.RockIT.VacancyForms.VacancyForm", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppVacancyForms", (string)null);
                });
            ...
            modelBuilder.Entity("Steer73.RockIT.VacancyApplications.VacancyApplication", b =>
                {
                    b.HasOne("Steer73.RockIT.Applicants.Applicant", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Steer73.RockIT.VacancyForms.VacancyForm", b =>
                {
                    ...
                    b.HasOne("Steer73.RockIT.VacancyApplications.VacancyApplication", null)
                        .WithMany()
