...
public class RockITDbMigrationService : ITransientDependency
{
    public ILogger<RockITDbMigrationService> Logger { get; set; }
        ...
        IEnumerable<IRockITDbSchemaMigrator> dbSchemaMigrators)
    {
        ...
        Logger = NullLogger<RockITDbMigrationService>.Instance;
    }
